...
def errorbar(self, x, y, yerr=None, xerr=None, fmt='', ecolor=None, elinewidth=None, capsize=None, barsabove=False, lolims=False, uplims=False, xlolims=False, xuplims=False, errorevery=1, capthick=None, **kwargs):
    ...
    if (xerr is not None):
        ...
        if xlolims.any():
            ...
            caplines.extend(self.plot(rightup, yup, ls='None', marker=marker, **plot_kw))
            if (capsize > 0):
        ...
        if xuplims.any():
            ...
            if self.xaxis_inverted():
                ...
                marker = mlines.CARETLEFTBASE
            caplines.extend(self.plot(leftlo, ylo, ls='None', marker=marker, **plot_kw))
            if (capsize > 0):
    ...
    if (yerr is not None):
        ...
        if lolims.any():
            ...
            caplines.extend(self.plot(xup, upperup, ls='None', marker=marker, **plot_kw))
            if (capsize > 0):
        ...
        if uplims.any():
            ...
            if self.yaxis_inverted():
                ...
                marker = mlines.CARETDOWNBASE
            caplines.extend(self.plot(xlo, lowerlo, ls='None', marker=marker, **plot_kw))
            if (capsize > 0):

def check_params(self):
    ...
    if (self.rate_limit or self.rate_limit_slot or self.forward_enp_slot):
        self.module.fail_json(msg='Error: The following parameters cannot be configuredbecause XML mode is not supported:rate_limit,rate_limit_slot,forward_enp_slot.')
def exec_module(self, **kwargs):
    ...
    if ((self.state == 'present') and changed):
        ...
        param = self.network_models.LoadBalancer(sku=(self.network_models.LoadBalancerSku(self.sku) if self.sku else None), location=self.location, frontend_ip_configurations=frontend_ip_configurations_param, backend_address_pools=backend_address_pools_param, probes=probes_param, inbound_nat_pools=inbound_nat_pools_param, load_balancing_rules=load_balancing_rules_param)

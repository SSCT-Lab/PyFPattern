def generate_zulip_bots_static_files() -> None:
    ...
    if os.path.isdir(bots_dir):
        try:
            ...
            print((("There was a permission error with Vagrant's NFS file      sharing on old versions of " + 'OSX. You can fix this by upgrading to the latest OSX High Sierra, or work around it ') + 'by giving read/write permissions to your /zulip folder to everyone.'))
            sys.exit(1)

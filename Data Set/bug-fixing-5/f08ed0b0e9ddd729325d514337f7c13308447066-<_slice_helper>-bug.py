def _slice_helper(tensor, slice_spec, var=None):
    ...
    if (isinstance(slice_spec, bool) or (isinstance(slice_spec, ops.Tensor) and (slice_spec.dtype == dtypes.bool)) or (isinstance(slice_spec, np.ndarray) and (slice_spec.dtype == bool)) or (isinstance(slice_spec, (list, tuple)) and (np.asarray(slice_spec).dtype == bool))):

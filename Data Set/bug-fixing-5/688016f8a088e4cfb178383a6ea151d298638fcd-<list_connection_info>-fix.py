def list_connection_info(self):
    ...
    try:
        ...
        self.module.fail_json(msg=('Unable to read Network Manager settings from DBus system bus: %s' % to_native(e)), details='Please check if NetworkManager is installed andservice network-manager is started.')

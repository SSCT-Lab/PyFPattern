def _check_transformer(name, transformer_orig, X, y):
    ...
    if hasattr(transformer, 'transform'):
        ...
        if hasattr(X, 'T'):
            with assert_raises(ValueError, msg='The transformer {} does not raise an error when the number of features in transform is different from the number of features in fit.'.format(name)):

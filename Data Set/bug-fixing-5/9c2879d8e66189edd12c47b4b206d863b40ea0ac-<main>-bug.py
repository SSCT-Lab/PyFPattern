def main():
    ...
    if (state == 'absent'):
        ...
        if ((display_name is None) and (not mso.existing)):
            display_name = epg
        payload = dict(name=epg, displayName=display_name, uSegEpg=useg_epg, intraEpg=intra_epg_isolation, proxyArp=intersite_multicaste_source, subnets=subnets, bdRef=bd_ref)

def load_callbacks(self):
    ...
    for callback_plugin in callback_loader.all(class_only=True):
        ...
        try:
            ...
            display.deprecated(("%s callback, does not support setting 'options', it will work for now,  but this will be required in the future and should be updated,  see the 2.4 porting guide for details." % self._stdout_callback._load_name), version='2.9')

def get_hosts(self, config):
    ...
    if hosts_list:
        for host in hosts_list:
            ...
            tls_hostname = (host.get('tls_hostname') or def_tls_hostname or self._args.tls_hostname or self._env_args.tls_hostname)
            ...
            default_ip = (host.get('default_ip') or def_ip or self._args.default_ip_address or DEFAULT_IP)

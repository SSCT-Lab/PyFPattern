def _wrap_function(function, ffi):
    ...
    def safe_call(*args, **kwargs):
        args = tuple(((ffi.cast((_torch_to_cffi.get(type(arg), 'void') + '*'), arg._cdata) if (torch.is_tensor(arg) or torch.is_storage(arg) or isinstance(arg, Variable)) else arg) for arg in args))
        args = ((function,) + args)

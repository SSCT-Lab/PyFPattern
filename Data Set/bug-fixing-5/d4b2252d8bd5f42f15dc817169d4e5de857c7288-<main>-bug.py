def main():
    module = AnsibleModule(argument_spec=dict(name=dict(type='str', required=True), state=dict(type='str', required=True, choices=['absent', 'present']), createparent=dict(type='bool', default=None), extra_zfs_properties=dict(type='dict', default={

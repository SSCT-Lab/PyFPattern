def initialize_state(self, variance=None, complex_step=False):
    ...
    if (self._k_order > 0):
        ...
        initial_state_cov_stationary = solve_discrete_lyapunov(self.ssm['transition', start:end, start:end, 0], selected_state_cov_stationary, complex_step=complex_step)

...
@pytest.mark.parametrize('expected_result', [(Int64Index([0, 1, 0, 1, 2], dtype='int64'), np.array([])), (Int64Index([0, 1, 0, 1, 2, 2], dtype='int64'), np.array([])), (Int64Index([0, 1, 0, 1, 2, 2, (- 1)], dtype='int64'), np.array([3])), (Int64Index([0, 1, 0, 1, 2, 2, (- 1), 0, 1, 2], dtype='int64'), np.array([3]))])

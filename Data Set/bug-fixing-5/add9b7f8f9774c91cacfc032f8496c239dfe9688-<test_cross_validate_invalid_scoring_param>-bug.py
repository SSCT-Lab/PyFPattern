def test_cross_validate_invalid_scoring_param():
    ...
    assert_raises_regex(ValueError, "Can't handle mix of binary and continuous", cross_validate, estimator, X, y, scoring=multiclass_scorer)
    assert_raises_regex(ValueError, "Can't handle mix of binary and continuous", cross_validate, estimator, X, y, scoring={

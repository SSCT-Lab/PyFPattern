    ...
    if unit:
        ...
        if (module.params['enabled'] is not None):
            ...
            if (rc == 0):
                ...
                if ((module.params['scope'] == 'system') and (not module.params['user']) and is_initd and ((not out.strip().endswith('disabled')) or sysv_is_enabled(unit))):
                    enabled = True

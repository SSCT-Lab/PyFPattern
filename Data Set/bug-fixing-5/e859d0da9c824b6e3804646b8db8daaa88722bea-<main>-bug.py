def main():
    argument_spec = dict(name=dict(type='str', required=True), state=dict(type='str', choices=['absent', 'present'], default='present'), data=dict(type='str'), labels=dict(type='dict'), force=dict(type='bool', default=False))

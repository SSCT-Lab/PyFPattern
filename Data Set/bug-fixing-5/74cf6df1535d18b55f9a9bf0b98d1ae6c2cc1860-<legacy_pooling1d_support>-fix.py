def legacy_pooling1d_support(func):
    ...
    def wrapper(*args, **kwargs):
        if (len(args) > 2):
            raise TypeError((args[0].__class__.__name__ + ' layer can have at most one positional argument (the `pool_size` argument).'))
        ...
        kwargs = convert_legacy_kwargs(args[0].__class__.__name__, args[1:], kwargs, conversions)

def sequence_fc(net, seq_len, num_layer, prefix, num_hidden_list=[], act_type_list=[], is_batchnorm=False):
        ...
        if (num_layer > 0):
            ...
            for seq_index in range(seq_len):
                for layer_index in range(num_layer):
                    ...
                    if is_batchnorm:
                        hidden = fc(net=hidden, num_hidden=num_hidden_list[layer_index], act_type=act_type_list[layer_index], weight=weight_list[layer_index], no_bias=is_batchnorm)

def create_autoscaling_group(connection):
    ...
    try:
        ...
        module.fail_json(msg='Failed to describe auto scaling groups.', exception=traceback.format_exc())
    ...
    if (not as_groups):
        ...
        try:
            ...
            module.fail_json(msg='Failed to describe launch configurations', exception=traceback.format_exc())
            ...
            if ((has_elbs - wanted_elbs) and change_load_balancers):
                ...
                if elbs_to_detach:
                    ...
                    try:
                        ...
                        module.fail_json(msg=('Failed to detach load balancers %s: %s.' % (elbs_to_detach, to_native(e))), exception=traceback.format_exc())
            if (wanted_elbs - has_elbs):
                ...
                if elbs_to_attach:
                    ...
                    try:
                        ...
                        module.fail_json(msg=('Failed to attach load balancers %s: %s.' % (elbs_to_attach, to_native(e))), exception=traceback.format_exc())
            ...
            if has_tgs.issuperset(wanted_tgs):
                ...
                if tgs_to_detach:
                    ...
                    try:
                        ...
                        module.fail_json(msg=('Failed to detach load balancer target groups %s: %s' % (tgs_to_detach, to_native(e))), exception=traceback.format_exc())
            if wanted_tgs.issuperset(has_tgs):
                ...
                if tgs_to_attach:
                    ...
                    try:
                        ...
                        module.fail_json(msg=('Failed to attach load balancer target groups %s: %s' % (tgs_to_attach, to_native(e))), exception=traceback.format_exc())
        if (min_size is None):
        ...
        try:
            ...
            module.fail_json(msg=('Failed to update autoscaling group: %s' % to_native(e)), exception=traceback.format_exc())
        if notification_topic:
            try:
                put_notification_config(connection, group_name, notification_topic, notification_types)
            except botocore.exceptions.ClientError as e:

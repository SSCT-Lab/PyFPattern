def main():
    ...
    element_spec = dict(name=dict(), full_name=dict(), role=dict(choices=ROLES), sshkey=dict(), state=dict(choices=['present', 'absent'], default='present'), active=dict(type='bool', default=True))

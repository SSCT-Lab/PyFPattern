def main():
    ...
    argument_spec.update(dict(name=dict(required=True, type='str'), path=dict(default='/', required=False, type='str'), assume_role_policy_document=dict(required=False, type='json'), managed_policy=dict(default=None, required=False, type='list'), state=dict(default=None, choices=['present', 'absent'], required=True)))

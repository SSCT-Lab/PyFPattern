def add_data_norm_table(self, table_id, learning_rate, param_var, grad_var, strategy, sparse_table_names):
    ...
    table.table_class = strategy.get('datanorm_table_class', 'DownpourDenseDoubleTable')
    table.type = pslib.PS_DENSE_TABLE
    table.compress_in_save = strategy.get('datanorm_compress_in_save', True)
    table.accessor.accessor_class = strategy.get('datanorm_accessor_class', 'DownpourDenseValueDoubleAccessor')
    table.accessor.dense_sgd_param.name = strategy.get('datanorm_operation', 'summarydouble')

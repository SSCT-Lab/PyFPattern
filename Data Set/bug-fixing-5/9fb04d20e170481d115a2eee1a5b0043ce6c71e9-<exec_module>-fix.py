def exec_module(self, **kwargs):
    ...
    if changed:
        if (self.state == 'present'):
            subnet = self.network_models.SubResource('/subscriptions/{0}/resourceGroups/{1}/providers/Microsoft.Network/virtualNetworks/{2}/subnets/{3}'.format(self.subscription_id, virtual_network_resource_group, virtual_network_name, self.subnet_name))

def main():
    ...
    with settings.runtime_values(**tower_auth):
        ...
        try:
            ...
            for key in ('authorize', 'authorize_password', 'client', 'secret', 'tenant', 'subscription', 'domain', 'become_method', 'become_username', 'become_password', 'vault_password', 'project', 'host', 'username', 'password', 'ssh_key_data', 'ssh_key_unlock'):
                if ('kind' in params):

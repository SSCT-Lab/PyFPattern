def get(self, request):
    ...
    team = Team(id=1, slug='team', name='My Team', organization=org)
    project = Project(id=1, organization=org, team=team, slug='project', name='My Project')
    return MailPreview(html_template='sentry/emails/activity/new_processing_issues.html', text_template='sentry/emails/activity/new_processing_issues.txt', context={
        'project': project,
        ...
        'info_url': absolute_uri('/{}/{}/settings/processing-issues/'.format(org.slug, project.slug)),
    }).render(request)
def path_dwim_relative_stack(self, paths, dirname, source, is_role=False):
    ...
    if (source is None):
        ...
        for path in paths:
            ...
            if (is_role or ((b_upath.endswith(b'tasks') and os.path.exists(os.path.join(b_upath, b'main.yml'))) or os.path.exists(os.path.join(b_upath, b'tasks/main.yml')) or os.path.exists(os.path.join(b_mydir, b'tasks/main.yml')))):

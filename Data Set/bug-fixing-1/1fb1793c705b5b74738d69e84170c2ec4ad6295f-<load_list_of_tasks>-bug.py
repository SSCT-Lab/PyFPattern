                ...
                for param in ir.args:
                    if templar._contains_vars(ir.args[param]):
                        if (not templar.is_template(ir.args[param])):
                            ...
                            break
                is_static = (C.DEFAULT_TASK_INCLUDES_STATIC or (use_handlers and C.DEFAULT_HANDLER_INCLUDES_STATIC) or ((not needs_templating) and ir.all_parents_static() and (not ir.loop)))

...
def main():
    ...
    if (state == 'absent'):
        ...
        payload = dict(filterRef=dict(filterName=filter_name, templateName=filter_template, schemaId=filter_schema_id), directives=filter_directives)

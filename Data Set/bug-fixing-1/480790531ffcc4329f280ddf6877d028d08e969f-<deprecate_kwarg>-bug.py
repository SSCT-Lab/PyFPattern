    ...
    def _deprecate_kwarg(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if ((new_arg_name is None) and (old_arg_value is not None)):
                msg = "the '{old_name}' keyword is deprecated and will be removed in a future version please takes steps to stop use of '{old_name}'".format(old_name=old_arg_name)

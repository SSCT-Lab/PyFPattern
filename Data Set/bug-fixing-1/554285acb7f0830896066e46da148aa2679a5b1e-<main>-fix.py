...
def main():
    ...
    }), volume=dict(default=None), state=dict(default='present', choices=['absent', 'present']))
    module_kwargs = openstack_module_kwargs(mutually_exclusive=[['filename', 'volume']])
    ...
    try:
        ...
        if module.params['id']:
            ...
            image = cloud.get_image(name_or_id=module.params['name'], filters={

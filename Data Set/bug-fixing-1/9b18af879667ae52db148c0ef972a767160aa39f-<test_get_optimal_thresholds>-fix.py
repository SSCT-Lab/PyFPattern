...
def test_get_optimal_thresholds():
    ...
    nd_dict = {
        'layer1': mx.nd.uniform(low=(- 10.532), high=11.3432, shape=(8, 3, 23, 23), dtype=np.float64),
    }
    ...
    assert_almost_equal(np.array([th_dict['layer1'][1]]), expected_threshold, rtol=0.01, atol=0.0001)

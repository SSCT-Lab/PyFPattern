...
def test_multinomial_generator():
    ...
    for dtype in ['float16', 'float32', 'float64']:
        ...
        verify_generator(generator=generator_mx, buckets=buckets, probs=quantized_probs, nsamples=samples, nrepeat=trials)
        ...
        verify_generator(generator=generator_mx_same_seed, buckets=buckets, probs=quantized_probs, nsamples=samples, nrepeat=trials)

...
def unmerge(project_id, source_id, destination_id, fingerprints, actor_id, last_event=None, batch_size=500, source_fields_reset=False, eventstream_state=None):
    ...
    unmerge.delay(project_id, source_id, destination_id, fingerprints, actor_id, last_event={
        'timestamp': events[(- 1)].timestamp,
        'event_id': events[(- 1)].event_id,
    }, batch_size=batch_size, source_fields_reset=source_fields_reset, eventstream_state=eventstream_state)

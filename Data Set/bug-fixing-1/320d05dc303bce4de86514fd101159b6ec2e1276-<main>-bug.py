...
def main():
    ...
    with settings.runtime_values(**tower_auth):
        ...
        for key in ('allow_simultaneous', 'extra_vars', 'survey_enabled', 'description'):

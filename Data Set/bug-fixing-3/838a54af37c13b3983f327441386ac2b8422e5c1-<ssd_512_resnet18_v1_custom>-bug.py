def ssd_512_resnet18_v1_custom(classes, pretrained_base=True, transfer=None, **kwargs):
    ...
    if (transfer is None):
        ...
        net = get_ssd('resnet18_v1', 512, features=['stage3_activation1', 'stage4_activation1'], filters=[512, 512, 256, 256], sizes=[51.2, 102.4, 189.4, 276.4, 363.52, 450.6, 492], ratios=(([[1, 2, 0.5]] + ([[1, 2, 0.5, 3, (1.0 / 3)]] * 3)) + ([[1, 2, 0.5]] * 2)), steps=[8, 16, 32, 64, 128, 256, 512], classes=classes, dataset='', pretrained_base=pretrained_base, **kwargs)
    else:

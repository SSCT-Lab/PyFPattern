def stack_bidirectional_dynamic_rnn(cells_fw, cells_bw, inputs, initial_states_fw=None, initial_states_bw=None, dtype=None, sequence_length=None, parallel_iterations=None, scope=None):
    ...
    with vs.variable_scope((scope or 'stack_bidirectional_rnn')):
        for (i, (cell_fw, cell_bw)) in enumerate(zip(cells_fw, cells_bw)):
            ...
            with vs.variable_scope(('cell_%d' % i)):
                (outputs, (state_fw, state_bw)) = rnn.bidirectional_dynamic_rnn(cell_fw, cell_bw, prev_layer, initial_state_fw=initial_state_fw, initial_state_bw=initial_state_bw, sequence_length=sequence_length, parallel_iterations=parallel_iterations, dtype=dtype)

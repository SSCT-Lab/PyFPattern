def create_linode(module, client, **kwargs):
    ...
    try:
        ...
        module.fail_json(msg='Unable to parse Linode instance creation response. Please raise a bug against this module on https://github.com/ansible/ansible/issues')
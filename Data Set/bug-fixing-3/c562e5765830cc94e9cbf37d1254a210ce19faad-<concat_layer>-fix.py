...
def concat_layer(input, act=None, name=None, layer_attr=None, bias_attr=None):
    ...
    layer = Layer(name=name, type=layer_type, inputs=([x.name for x in input] if is_concat_layer else input), active_type=act.name, bias=ParamAttr.to_bias(bias_attr), **ExtraLayerAttribute.to_kwargs(layer_attr))

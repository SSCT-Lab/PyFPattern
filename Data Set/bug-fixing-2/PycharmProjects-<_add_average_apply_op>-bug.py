...
def _add_average_apply_op(self, block, param_grad):
    ...
    num_accumulates = block.clone_variable(self._get_accumulator('num_accumulates', param))
    old_num_accumulates = block.clone_variable(self._get_accumulator('old_num_accumulates', param))
    num_updates = block.clone_variable(self._get_accumulator('num_updates', param))

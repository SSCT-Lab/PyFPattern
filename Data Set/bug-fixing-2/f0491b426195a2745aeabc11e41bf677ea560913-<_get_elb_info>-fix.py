...
def _get_elb_info(self, elb):
    ...
    if elb.instances:
        ...
        try:
            elb_info['instances_inservice_percent'] = ((float(elb_info['instances_inservice_count']) / float((elb_info['instances_inservice_count'] + elb_info['instances_outofservice_count']))) * 100.0)
        except ZeroDivisionError:
            elb_info['instances_inservice_percent'] = 0.0
    return elb_info

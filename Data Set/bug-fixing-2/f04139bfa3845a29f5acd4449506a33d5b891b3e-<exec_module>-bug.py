...
def exec_module(self, **kwargs):
    ...
    try:
        ...
        if (self.state == 'present'):
            ...
            if (self.os_disk_size_gb and (self.os_disk_size_gb != vm_dict['properties']['storageProfile']['osDisk']['diskSizeGB'])):
